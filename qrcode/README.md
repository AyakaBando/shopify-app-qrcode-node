...
# Command
1. Create directory, npm install, then run it
  ``` 
  mkdir app_name
  cd app_name
  npm install
...
Preview URL:
https://quickstart-3749937e.myshopify.com/admin/oauth/redirect_from_cli?client_id=3ac1d2a9e620c1d9c82f36d96ec7deb9
